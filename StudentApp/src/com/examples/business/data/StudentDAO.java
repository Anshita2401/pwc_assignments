...
public Connection conn;
    ...
    public StudentDAO()
    {
      ...
      public ArrayList fetchStudentData()
      {
    	  ...
    	  try
    	  {
    		  rs = stmt.executeQuery("select student_roll_no,student_name,student_gender,maths_marks,physics_marks,chemistry_marks,computer_science_marks,city,email from student_master");
    		  list = new ArrayList();
    		  while(rs.next())
    		  {
    			  stud = new Student();
